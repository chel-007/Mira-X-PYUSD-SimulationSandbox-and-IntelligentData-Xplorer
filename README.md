...
- by querying the `bigquery-public-data.goog_blockchain_ethereum_mainnet_us` dataset, i was able to backfill ***PYUSD*** transaction history into two distinct tables - ***transfer_logs*** & ***lp_activity_and_gas***. take a look at the method used in [*this script*](./app/components/explore/backFillData/BigQueryBackfill.py) and [*this too*](./app/components/explore/backFillData/BigQueryBackfillGas.SQL)

![transfer_logs](images/transfer_logs.png)
...
![safe_offset_transfer_logs](images/safe_offset_transfer_logs.png)
...
![data_field_lp_activity_and_gas](images/data_field_lp_activity_and_gas.png)
...
![fly_pyusd_websocket](images/fly_pyusd_websocket.png)
...
![firestore_collection](images/firestore_collection.png)
...
![velocity_of_transfers](images/velocity_of_transfers.png)
...
![add_tx_flow_sandbox](images/add_tx_flow_sandbox.png)
...
![timeline_sandbox](images/timeline_sandbox.png)
